...
function proposalChoices(date,exclude=[]){const season=calendarSeasonForDate(date);return recipes.filter(r=>!exclude.includes(r.id)&&norm(r.category)==='plat principal'&&((r.season||'toute-annee')==='toute-annee'||r.season===season));}
