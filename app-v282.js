...
async function init(){
  ...
  if('serviceWorker' in navigator) navigator.serviceWorker.register('sw.js?v=2930', {updateViaCache:'none'});
...
$('#recipeCategory').onchange=()=>editableSelectOther($('#recipeCategory'),'catégorie');
$('#restaurantCityField').onchange=()=>editableSelectOther($('#restaurantCityField'),'lieu');
$('#restaurantCountryField').onchange=()=>editableSelectOther($('#restaurantCountryField'),'pays');
$('#producerTypeField').onchange=()=>editableSelectOther($('#producerTypeField'),'type');
$('#producerRegionField').onchange=()=>editableSelectOther($('#producerRegionField'),'région');
$('#producerCityField').onchange=()=>editableSelectOther($('#producerCityField'),'lieu');
